...
<head>
    ...
    <title>IYCNC IDC 개발자 프로파일 진행 현황 [인력기초원장]: IYF 영업관리시스템</title>
    
     <!-- Google Fonts -->
    <link href="https://fonts.gstatic.com" rel="preconnect">
    <link
        href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunidc:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i"
        rel="stylesheet">
...
<!--             <div class="container"> -->
				<div id="title" class="d-flex justify-content-center" style="width: 80vw;">
			  		<span style="font-size: 20px; font-weight: 550; color: #012970c7; font-family: 'Nunidc', sans-serif;">IYCNC IDC 개발자 프로파일 진행 현황 [인력기초원장]</span>
				</div>
...
<!--         </section> -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // 그리드 데이터 ajax로 가져오기
            $.ajax({
                url: "${pageContext.request.contextPath}/empLedger.ajax/company/IYCNC/department/IDC" ,
                method: "GET",
            ...
            $('#btnShowRegisterPage').click(function() {
                const popupUrl = '${pageContext.request.contextPath}/iycnc/idc/empLedgerRegister';
            ...
            grid.on('dblclick', function(ev) {
                ...
                const popupUrl = '${pageContext.request.contextPath}/iycnc/idc/empLedgerDetail?emp_id='+ empLedger.emp_id;
            ...
            $('a[data-bs-target="#iycnc-idc-nav"]').attr('class', 'nav-link');
       		...
       		$('ul#iycnc-idc-nav li:eq(0) a').attr('class', 'active');
