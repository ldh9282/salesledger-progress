...
<head>
    ...
    <title>IYCNC IDC 용역원가 [매출원장]: IYF 영업관리시스템</title>
...
<!--             <div class="container"> -->
				<div id="title" class="d-flex justify-content-center" style="width: 80vw;">
			  		<span style="font-size: 20px; font-weight: 550; color: #012970c7; font-family: 'Nunito', sans-serif;">IYCNC IDC 용역원가 [매출원장]</span>
				</div>
...
<!--         </section> -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // 그리드 데이터 ajax로 가져오기
            $.ajax({
                url: "${pageContext.request.contextPath}/salesLedger.ajax/company/IYCNC/department/IDC",
                method: "GET",
            ...
            grid.on('dblclick', function (ev) {
                ...
                const popupUrl = '${pageContext.request.contextPath}/iycnc/idc/salesLedgerDetail?sales_id=' + salesLedger.sales_id;
            ...
            $('a[data-bs-target="#iycnc-idc-nav"]').attr('class', 'nav-link');
       		...
       		$('ul#iycnc-idc-nav li:eq(1) a').attr('class', 'active');
