...
<head>
    ...
    <title>IBTS 인력기초원장: IYF 인력기초원장/매출원장</title>
</head>
...
<body>
        ...
        <section>
            <div class="container">
                ...
                <div class="d-flex mt-3 mb-3">
                    <button type="button" class="btn btn-primary ms-2" id="btnShowRegisterPage">인력원장등록</button>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // 그리드 데이터 ajax로 가져오기
            $.ajax({
                url: "${pageContext.request.contextPath}/empLedger.ajax/company/IBTS" ,
                method: "GET",
            ...
            grid.on('dblclick', function(ev) {
                ...
                const popupUrl = '${pageContext.request.contextPath}/ibts/empLedgerDetail.do?emp_id='+ empLedger.emp_id;
                const popupName = 'empLedgerDetail.do-popup';
         	...
         	// 인력원장등록페이지 버튼 클릭시 이벤트: 페이지팝업
            $('#btnShowRegisterPage').click(function() {
                const popupUrl = '${pageContext.request.contextPath}/ibts/empLedgerRegister.do';
