...
<head>
    ...
    <title>IBTS 컨버전스 매출실적 수기데이터 등록 페이지: IYF 영업관리시스템</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <section>
            <div class="container">
                <h3>IBTS 컨버전스 매출실적 수기데이터 등록 페이지</h3>
                <hr>
                <form id="salesResultForm">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="company" name="company" readonly value="IBTS">
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" class="form-control" id="department" name="department" value="CONVERSION">
                    </div>
                    <div class="form-group mb-3">
        ...
        $(document).ready(function () {
            $('#btnInsert').click(function() {
                ...
                if (!confirm(year + '년 ' + month + '월 매출 실적에 해당 데이터를 수기로 추가하시겠습니까?')) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "${pageContext.request.contextPath}/salesResult.ajax/company/IBTS/department/CONVERSION/batch_month/" + $('#batch_month').val(),
