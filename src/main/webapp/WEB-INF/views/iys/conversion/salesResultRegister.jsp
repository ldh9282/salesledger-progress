...
<head>
    ...
    <title>IYS 컨버전스 매출실적 수기데이터 등록 페이지: IYF 영업관리시스템</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <section>
            <div class="container">
                <h3>IYS 컨버전스 매출실적 수기데이터 등록 페이지</h3>
                <hr>
        ...
        $(document).ready(function () {
            $('#btnInsert').click(function() {
                ...
                if (!confirm(year + '년 ' + month + '월 매출 실적에 해당 데이터를 수기로 추가하시겠습니까?')) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "${pageContext.request.contextPath}/salesResult.ajax/company/IYS/department/CONVERSION/batch_month/" + $('#batch_month').val(),
