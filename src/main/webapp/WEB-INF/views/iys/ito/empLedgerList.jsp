...
<head>
    ...
    <title>IYS ITO 개발자 프로파일 진행 현황 [인력기초원장]: IYF 영업관리시스템</title>
...
<!--             <div class="container"> -->
				<div id="title" class="d-flex justify-content-center" style="width: 80vw;">
			  		<span style="font-size: 20px; font-weight: 550; color: #012970c7; font-family: 'Nunito', sans-serif;">IYS ITO 개발자 프로파일 진행 현황 [인력기초원장]</span>
				</div>
...
<!--         </section> -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // 그리드 데이터 ajax로 가져오기
            $.ajax({
                url: "${pageContext.request.contextPath}/empLedger.ajax/company/IYS/department/ITO" ,
                method: "GET",
            ...
            $('#btnShowRegisterPage').click(function() {
                const popupUrl = '${pageContext.request.contextPath}/iys/ito/empLedgerRegister';
            ...
            grid.on('dblclick', function(ev) {
                ...
                const popupUrl = '${pageContext.request.contextPath}/iys/ito/empLedgerDetail?emp_id='+ empLedger.emp_id;
            ...
            $('a[data-bs-target="#iys-ito-nav"]').attr('class', 'nav-link');
       		...
       		$('ul#iys-ito-nav li:eq(0) a').attr('class', 'active');
